    ...
    public class CompPawnFog : ThingComp, IExposable
    {
        ...
        public void RevealSkill(SkillDef skillDef)
        {
            ...
            var letter = LetterMaker.MakeLetter(
                ...
                "FogOfPawn.SkillRevealed.Text".Translate(parent.LabelShort, skillDef.label, parent.skills.GetSkill(skillDef).Level),
        ...
        public void RevealTrait(Trait trait)
        {
            ...
            var letter = LetterMaker.MakeLetter(
                ...
                trait.def.degree > 0 ? LetterDefOf.NegativeEvent : LetterDefOf.PositiveEvent,
                parent
            );
            Find.LetterStack.ReceiveLetter(letter);
